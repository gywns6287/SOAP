...
from projects.mmdet3d_plugin.utils.semkitti import kitti_360_class_frequencies
from projects.mmdet3d_plugin.utils.semkitti import nuscenes_class_frequencies

from .queryfuse import QueryFuse
...
class Mask2FormerOccHead(MaskFormerHead):
    ...
    def __init__(self,
        ...
        self.query_fuse = ModuleList()
        for _ in range(self.num_transformer_decoder_layers):
            self.query_fuse.append(
                QueryFuse(feat_channels)
            ) 
        # self.query_fuse = QueryFuse(feat_channels)
        ...
        elif self.num_classes == 19:
            class_frequencies = kitti_360_class_frequencies
        elif self.num_classes == 13:
            class_frequencies = nuscenes_class_frequencies
    ...
    def loss_single(self, cls_scores, mask_preds, gt_labels_list,
        ...
        # extract positive ones (matched voxel positions)
    ...
    def forward_train(self,
        ...
        # forward
        all_cls_scores, all_mask_preds, query_feats = self(voxel_feats, img_metas, sem_dic, sem_embed)
        ...
        return losses, all_cls_scores[-1], query_feats
    ...
    def forward(self, 
        ...
        for i in range(self.num_transformer_decoder_layers):
            ...
            # query fuse
            query_feat = self.query_fuse[i](query_feat, query_embed, sem_dic, sem_embed)
            query_feat = layer(
                query=query_feat,
        ...
        # query fuse
        # cls_pred_list2, mask_pred_list2, query_feat = self.query_fuse(query_feat, query_embed, sem_dic, sem_embed, mask_features)

        # cls_pred_list = cls_pred_list + cls_pred_list2
        # mask_pred_list = mask_pred_list + mask_pred_list2
        '''
        Returns:
            tuple: A tuple contains two elements.
    ...
    def simple_test(self, 
        ...
        return res, mask_cls_results, query_feats
