...
class LoadSemKittiAnnotation():
    ...
    def __call__(self, results):
        ...
        imgs, rots, trans, rel_rots, rel_trans, intrins, post_rots, post_trans, stereo_depths, sensor2sensors, gt_depths = results['img_inputs']
        results['img_inputs'] = (imgs, rots, trans, rel_rots, rel_trans, intrins, post_rots, post_trans, bda_rot, stereo_depths, sensor2sensors, gt_depths)
        
        results['gt_occ'] = gt_occ.long() if gt_occ != [] else []
