...
camera_used = ['left']
# load_from = '/mnt/hdddata2/lhj/ckpts/iou47.15_miou19.03.pth'
...
grid_config = {
    'xbound': [point_cloud_range[0], point_cloud_range[3], voxel_x ],
    'ybound': [point_cloud_range[1], point_cloud_range[4], voxel_y ],
    'zbound': [point_cloud_range[2], point_cloud_range[5], voxel_z ],
    'dbound': [2.0, 58.0, 0.5],
}

target_frames = [-3, -6, -9, -12] 
# settings for 3D encoder
numC_Trans = 192
voxel_channels = [192, 192, 192, 192]#[128, 256, 512, 1024]
...
ann_file = 'data/SemanticKITTI/dataset/labels'
depth_path = 'data/SemanticKITTI/dataset/stereodepth'
...
train_pipeline = [
    dict(type='LoadMultiViewImageFromFiles_SemanticKitti', is_train=True,
            ...
            stereo_path=depth_path, dataset='kitti'),
...
test_config=dict(
    ...
    split='val', # to test for submission
